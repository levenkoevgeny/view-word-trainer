<template>
  ...
  <div v-else>
    ...
    <main>
      ...
      <!--          <p>-->
      <!--            &lt;!&ndash;            <a href="#" class="btn btn-primary my-2">Main call to action</a>&ndash;&gt;-->
      <!--            &lt;!&ndash;            <a href="#" class="btn btn-secondary my-2">Secondary action</a>&ndash;&gt;-->
      <!--          </p>-->
      <!--        </div>-->
      <!--      </div>-->
      <!--    </section>-->
      <div class="my-3">
        <button type="button" class="btn btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#addDictionaryModalHome">
          Добавить словарь
        </button>
      </div>
      <div class="album py-5 bg-light">
        <div class="container">
          <div v-if="dictionariesList.length > 0">
            <h1 class="mb-3">Ваши словари</h1>
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
              <div class="col" v-for="dict in dictionariesList" :key="dict.id">
                <div class="card shadow-sm">
                  <div class="d-flex justify-content-center align-items-center">
                    <img :src="getLogoUrl(dict.logo)" class="img-fluid m-2" alt="No image"
                         style="width: 50%; height: 150px;" v-if="dict.logo">
                    <img :src="getLogoUrlDefault()" class="img-fluid m-2" alt="No image"
                         style="width: 50%; height: 150px;" v-else>
                  </div>
                          ...
                          <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                            ...
                            <li>
                              <button class="dropdown-item"
                                      @click="changeRoute(dict.id, 'dictionaries_spelling_training')">
          ...
          <div v-else>
            <h3>У Вас еще нет ни одного словаря</h3>
          </div>
          <div v-if="dictionariesListCommon.length > 0">
